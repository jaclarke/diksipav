...
<div class="intro">
	...
	<div class="text">
		...
		<p class="top-margin">
			I've primarily been focusing on JS/TS, but lately I've started spending some good hours with
			Rust & I plan to socialize with it more.
		</p>
		<p class="top-margin">
...
<style lang="scss">
	...
	.text :global(.mountain-wrapper) {
		...
		position: absolute;
		@include responsive(bottom, -20px, $xl: -48px);
		@include responsive(right, 208px, $xl: 170px);
		opacity: 0.3;
		z-index: -1;
	}
</style>
